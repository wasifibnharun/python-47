...
def add_item():
    if part_text.get()=='' or customer_text.get()=='' or retailer_text.get()== '' or price_text.get()=='':
        ...
        return
    db.insert(part_text.get().rstrip(),customer_text.get().rstrip(),retailer_text.get().rstrip(),price_text.get().rstrip())
    parts_list.delete(0,END)
    parts_list.insert(END,(part_text.get().rstrip(),customer_text.get().rstrip(),retailer_text.get().rstrip(),price_text.get().rstrip()))
    clear_text()
    populate_list()
...
def update_item():
    db.update(selected_item[0],part_text.get().rstrip(),customer_text.get().rstrip(),retailer_text.get().rstrip(),price_text.get().rstrip())
    populate_list()
